...
describe('firstMove function test', function() {
  ...
  it('Returns corner position 0 when side position 1 is passed in', function() {
    expect(firstMove(1)).to.equal(0);
  });

  it('Returns corner position 0 when side position 3 is passed in', function() {
    expect(firstMove(3)).to.equal(0);
  });
  ...
  it('Returns corner position 8 when side position 5 is passed in', function() {
    expect(firstMove(5)).to.equal(8);
  });

  it('Returns corner position 8 when side position 7 is passed in', function() {
    expect(firstMove(7)).to.equal(8);
  });
